...
if datetime.now().month == 12:  # in december
    logo = Image.open("C:/Users/siriv/Downloads/vide_qa_model/graphics/logo_design_winter.png")  # winter-theme
else:  # every other month
    logo = Image.open("C:/Users/siriv/Downloads/vide_qa_model/graphics/logo_design_3.png")  # base
...
comp_year_df = pd.read_csv("C:/Users/siriv/Downloads/vide_qa_model/company_year.csv")
...
with doc2:
    ...
    choices_year = st.selectbox("Please select the year of your choice.", comp_year_df.loc[comp_year_df["company"] == choices_company, "year"])
...
# recording- and translation-functions may be enabled again at some point
# recording 
#audio_q = 0
...
# from key_file import translation_key
#auth_key = translation_key  # impport required
...
json_in = "C:/Users/siriv/Downloads/vide_qa_model/input_template.json"
...
if submit:  # if submit-button is clicked
    if query or query_2:  # if query is inserted, start computation
        with st.spinner("Please wait, our army of insanely intelligent raccoons skims the document for your answer."):
            import base64
            graphic_waiting = open("C:/Users/siriv/Downloads/vide_qa_model/graphics/waiting_animation_4.gif", "rb")  # waiting-animation
            ...
            # load in choice from the selection boxes
            #st.write("choices: ")
            #st.write(choices_company)
            #st.write(choices_year)
            #text_path = str(choices_company) + "_" + str(choices_year) + ".txt"
            #st.write("text path: ")
            #st.write(text_path)
            #text_path = "C:/Users/siriv/Downloads/Vide-main/Vide-main/data/COCA COLA CO_2022.txt"
            #with open(text_path) as f_input:
            #    text_sentences = f_input.read()  # reading in the chosen text-file
            ...
            # print index, cosine score and sentence
                ...
                if model_type == "Qualitative":
                    ...
                    class conf():
                        ...
                        root_path = "C:/Users/siriv/Downloads/vide_qa_model/"
                        output_path = "C:/Users/siriv/Downloads/vide_qa_model/path_to_store_outputs/"
                        cache_dir = "C:/Users/siriv/Downloads/vide_qa_model/path_for_other_cache/"
                        ...
                        op_list_file = "drive/MyDrive/ds_proj_model_parameters/operation_list.txt"
                        const_list_file = "drive/MyDrive/ds_proj_model_parameters/operation_list.txt"
                    ...
                    op_list = read_txt("C:/Users/siriv/Downloads/vide_qa_model/operation_list.txt", log_file)
                    op_list = [op + '(' for op in op_list]
                    op_list = ['EOF', 'UNK', 'GO', ')'] + op_list
                    const_list = read_txt("C:/Users/siriv/Downloads/vide_qa_model/constant_list.txt", log_file)
                    ...
                    def generate(data_ori, data, model, ksave_dir, mode='valid'):
                        ...
                        output_prediction_file = "C:/Users/siriv/Downloads/vide_qa_model/retriever_output.json"  # only used if results are saved
                    ...
                    def generate_test():
                        ...
                        model.load_state_dict(torch.load("C:/Users/siriv/Downloads/vide_qa_model/model_retriever.pt", map_location = torch.device('cpu')))  # changeable
                        model.eval()
                    ...
                    #conversion_output[0]["qa"]["question"] = "what percentage of the total oil and gas mmboe comes from canada?"
                    #conversion_output[0]["qa"]["model_input"] = [
                    #    [
                    #        "text_31",
                    ...
                    #    [
                    #        "table_3",
                    #        "the canada of oil ( mmbbls ) is 23 ; the canada of gas ( bcf ) is 198 ; the canada of ngls ( mmbbls ) is 4 ; the canada of total ( mmboe ) is 60 ;"
                    #    ],
                    #    [
                    #        "table_5",
                    #        "the total of oil ( mmbbls ) is 66 ; the total of gas ( bcf ) is 894 ; the total of ngls ( mmbbls ) is 28 ; the total of total ( mmboe ) is 243 ;"
                    #    ]
                    #]
                    ...
                    class conf():
                        ...
                        # set up your own path here
                        root_path = "C:/Users/siriv/Downloads/vide_qa_model/"
                        output_path = "C:/Users/siriv/Downloads/vide_qa_model/output_retriever_cuda/"
                        cache_dir = "C:/Users/siriv/Downloads/vide_qa_model/other_cache_generator"
                        ...
                        op_list_file = "C:/Users/siriv/Downloads/vide_qa_model/operation_list.txt"
                        const_list_file = "C:/Users/siriv/Downloads/vide_qa_model/constant_list.txt"
                    ...
                    saved_model_path = "C:/Users/siriv/Downloads/vide_qa_model/"
                    # model_dir_name = datetime.now().strftime("%Y%m%d%H%M%S")
                    model_dir_name = datetime.now().strftime("%Y%m%d%H%M%S") + \
                        "_" + conf.model_save_name
                    model_dir = os.path.join(
                    ...
                    def generate(data_ori, data, model, ksave_dir, mode='valid'):
                        ...
                        #output_prediction_file = "C:/Users/siriv/Downloads/vide_qa_model/prediction.json" #os.path.join(ksave_dir_mode,
                                                            #"predictions.json")
                        #output_nbest_file = "C:/Users/siriv/Downloads/vide_qa_model/nbest_predictions.json"
                        #output_eval_file = os.path.join("C:/Users/siriv/Downloads/vide_qa_model/", "evals.json")
                    ...
                    def generate_test():
                        ...
                        model = nn.DataParallel(model)
                        model.to(conf.device)
                        model.load_state_dict(torch.load(conf.saved_model_path, map_location = torch.device('cpu')))  # changeable
                        model.eval()
                    ...
                    # generate results for program generation
                ...
                graphic_no_find = Image.open("C:/Users/siriv/Downloads/vide_qa_model/graphics/no_answer_graphic_2.png")
    ...
    if done == 1:
        ...
        import pygame
        pygame.mixer.init()
        pygame.mixer.music.load("C:/Users/siriv/Downloads/vide_qa_model/sounds/w_short.mp3")
...
graphic_1 = Image.open("C:/Users/siriv/Downloads/vide_qa_model/graphics/example_graphic.png")
st.image(graphic_1)

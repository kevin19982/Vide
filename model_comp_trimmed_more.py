...
class conf():
    ...
    output_path = "C:/Users/siriv/Downloads/generator_test/path_to_store_outputs/"
    cache_dir = "C:/Users/siriv/Downloads/generator_test/path_for_other_cache/"
    ...
    test_file = root_path + "model_input_no_table.json"  # changeable
...
op_list = read_txt("C:/Users/siriv/Downloads/generator_test/operation_list.txt", log_file)
op_list = [op + '(' for op in op_list]
op_list = ['EOF', 'UNK', 'GO', ')'] + op_list
const_list = read_txt("C:/Users/siriv/Downloads/generator_test/constant_list.txt", log_file)
const_list = [const.lower().replace('.', '_') for const in const_list]
reserved_token_size = len(op_list) + len(const_list)


test_data, test_examples, op_list, const_list = \
    read_examples(input_path=conf.test_file, tokenizer=tokenizer,  # conf.test_file: replace with new input
...
def generate(data_ori, data, model, ksave_dir, mode='valid'):
    ...
    output_prediction_file = "C:/Users/siriv/Downloads/generator_test/retriever_output.json"  # only used if results are saved
...
def generate_test():
    ...
    model.load_state_dict(torch.load("C:/Users/siriv/Downloads/generator_test/model_retriever.pt", map_location = torch.device('cpu')))  # changeable
    model.eval()
...
class conf():
    ...
    op_list_file = "C:/Users/siriv/Downloads/generator_test/operation_list.txt"
    const_list_file = "C:/Users/siriv/Downloads/generator_test/constant_list.txt"
...
def generate(data_ori, data, model, ksave_dir, mode='valid'):
    ...
    output_prediction_file = "C:/Users/siriv/Downloads/generator_test/prediction.json" #os.path.join(ksave_dir_mode,
                                          #"predictions.json")
    output_nbest_file = "C:/Users/siriv/Downloads/generator_test/nbest_predictions.json"
    output_eval_file = os.path.join("C:/Users/siriv/Downloads/generator_test/", "evals.json")
...
def generate_test():
    ...
    model = nn.DataParallel(model)
    model.to(conf.device)
    model.load_state_dict(torch.load(conf.saved_model_path, map_location = torch.device('cpu')))
    model.eval()
